...
# Residual calculation (Way-1)
chisq$observed-round(chisq$expected,2)

# Residual calculation (Way-2)

# Standardization of residual (Pearson residual's calculations)
round(chisq$residuals, 3)

# Adjusted Standardized Residuals calculation (optional)
chisq$stdres
...
corrplot(chisq$residuals, is.cor = TRUE) # if the pearson residual -1 to +1
